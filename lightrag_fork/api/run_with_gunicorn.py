...
from lightrag_fork.api.utils_api import display_splash_screen, check_env_file
from lightrag_fork.api.config import global_args
...
def main():
    ...
    from lightrag_fork.api.config import initialize_config
    ...
    class GunicornApp(BaseApplication):
        ...
        def load_config(self):
            ...
            from lightrag_fork.api import gunicorn_config
        ...
        def load(self):
            ...
            from lightrag_fork.api.lightrag_server import get_application
