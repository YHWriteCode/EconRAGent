...
from lightrag_fork.api.utils_api import (
...
from lightrag_fork import LightRAG, __version__ as core_version
from lightrag_fork.api import __api_version__
from lightrag_fork.types import GPTKeywordExtractionFormat
from lightrag_fork.utils import EmbeddingFunc
...
from lightrag_fork.api.routers.document_routes import (
    DocumentManager,
    create_document_routes,
)
from lightrag_fork.api.routers.query_routes import create_query_routes
from lightrag_fork.api.routers.graph_routes import create_graph_routes
from lightrag_fork.api.routers.ollama_api import OllamaAPI

from lightrag_fork.utils import logger, set_verbose_debug
...
from lightrag_fork.api.auth import auth_handler
...
class LLMConfigCache:
    ...
    def __init__(self, args):
        ...
        if args.llm_binding in ["openai", "azure_openai"]:
            from lightrag_fork.llm.binding_options import OpenAILLMOptions
        ...
        if args.llm_binding == "gemini":
            from lightrag_fork.llm.binding_options import GeminiLLMOptions
        ...
        if args.embedding_binding == "ollama":
            try:
                from lightrag_fork.llm.binding_options import OllamaEmbeddingOptions
        ...
        if args.embedding_binding == "gemini":
            try:
                from lightrag_fork.llm.binding_options import GeminiEmbeddingOptions
...
def create_app(args):
    ...
    def create_optimized_azure_openai_llm_func(
        ...
        async def optimized_azure_openai_model_complete(
            ...
            **kwargs,
            ...
            from lightrag_fork.llm.azure_openai import azure_openai_complete_if_cache
    ...
    def create_optimized_embedding_function(
        ...
        try:
            if binding == "openai":
                ...
                from lightrag_fork.llm.azure_openai import azure_openai_embed

                provider_func = azure_openai_embed
            elif binding == "aws_bedrock":
                from lightrag_fork.llm.bedrock import bedrock_embed

                provider_func = bedrock_embed
            elif binding == "lollms":
                from lightrag_fork.llm.lollms import lollms_embed
    ...
    async def bedrock_model_complete(
        ...
        **kwargs,
        ...
        # Lazy import
        from lightrag_fork.llm.bedrock import bedrock_complete_if_cache
    ...
    if args.rerank_binding != "null":
        from lightrag_fork.rerank import cohere_rerank, jina_rerank, ali_rerank
    ...
    from lightrag_fork.api.config import OllamaServerInfos
    ...
    logging.config.dictConfig(
        {
            ...
            "filters": {
                "path_filter": {
                    "()": "lightrag_fork.utils.LightragPathFilter",
                },
            },
        }
    )
