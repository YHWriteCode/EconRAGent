...
Usage:
    ...
    python -m lightrag_fork.tools.check_initialization --demo
"""
...
from lightrag_fork.base import StoragesStatus
...
async def check_lightrag_setup(rag_instance: LightRAG, verbose: bool = False) -> bool:
    ...
    try:
        from lightrag_fork.kg.shared_storage import get_namespace_data
...
async def demo():
    ...
    from lightrag_fork.llm.openai import openai_embed, gpt_4o_mini_complete
