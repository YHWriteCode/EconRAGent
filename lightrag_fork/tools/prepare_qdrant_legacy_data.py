...
Usage:
    python -m lightrag_fork.tools.prepare_qdrant_legacy_data
    # or
    python lightrag_fork/tools/prepare_qdrant_legacy_data.py

    # Specify custom workspace
    python -m lightrag_fork.tools.prepare_qdrant_legacy_data --workspace space1

    # Process specific collection types only
    python -m lightrag_fork.tools.prepare_qdrant_legacy_data --types chunks,entities

    # Dry run (preview only, no actual changes)
    python -m lightrag_fork.tools.prepare_qdrant_legacy_data --dry-run
"""
