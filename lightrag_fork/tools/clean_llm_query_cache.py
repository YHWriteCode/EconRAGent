...
Usage:
    python -m lightrag_fork.tools.clean_llm_query_cache
    # or
    python lightrag_fork/tools/clean_llm_query_cache.py
...
from lightrag_fork.kg import STORAGE_ENV_REQUIREMENTS
from lightrag_fork.kg.shared_storage import set_all_update_flags
from lightrag_fork.namespace import NameSpace
from lightrag_fork.utils import setup_logger
...
class CleanupTool:
    ...
    def get_storage_class(self, storage_name: str):
        ...
        if storage_name == "JsonKVStorage":
            ...
            from lightrag_fork.kg.redis_impl import RedisKVStorage

            return RedisKVStorage
        elif storage_name == "PGKVStorage":
            from lightrag_fork.kg.postgres_impl import PGKVStorage

            return PGKVStorage
        elif storage_name == "MongoKVStorage":
            from lightrag_fork.kg.mongo_impl import MongoKVStorage

            return MongoKVStorage
        elif storage_name == "OpenSearchKVStorage":
            from lightrag_fork.kg.opensearch_impl import OpenSearchKVStorage
    ...
    async def count_query_caches_pg(self, storage) -> Dict[str, Dict[str, int]]:
        ...
        Returns:
            Dictionary with counts for each mode and cache_type
        """
        from lightrag_fork.kg.postgres_impl import namespace_to_table_name
    ...
    async def run(self):
        ...
        try:
            ...
            from lightrag_fork.kg.shared_storage import initialize_share_data
