...
from lightrag_fork.constants import DEFAULT_TEMPERATURE
    ...
    def generate_dot_env_sample(cls):
        ...
        sample_top = (
            ...
            + (
                ...
                "#\n"
                "# To generate run:\n"
                "# $ python -m lightrag_fork.llm.binding_options\n"
            )
            + "#" * 80
            + "\n"
        )
...
#
# Usage:
#   python -m lightrag_fork.llm.binding_options           # Generate .env sample
#   python -m lightrag_fork.llm.binding_options test      # Test argument parsing
#
# =============================================================================
